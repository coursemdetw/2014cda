...
class CDAG15(object):
    ...
    def index(self, *args, **kwargs):
        outstring = '''
這是 2014CDA 協同專案下的 cdag15分組程式開發網頁, 以下為 W12 的任務執行內容.<br />
<!-- 這裡採用相對連結, 而非網址的絕對連結 (這一段為 html 註解) -->
<a href="cube1">cdag15 正方體參數繪圖</a>(尺寸變數 a, b, c)<br /><br />
...
'''
    ...
    import programs.cdag15 as cdag15
    root.cdag15 = cdag15.CDAG15()
    
    則程式啟動後, 可以利用 /cdag15/cube1 呼叫函式執行
    '''
    @cherrypy.expose
