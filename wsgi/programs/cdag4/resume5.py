...
import programs.cdag4.resume5 as cdag4_resume5
# 加入 cdag4 模組下的 resume5.py 且以子模組 resume5 對應其 RESUME5() 類別
root.cdag4.resume5 = cdag4_resume5.RESUME5()

# 完成設定後, 可以利用
/cdag4/resume5/assembly
# 呼叫 resume5.py 中 RESUME5 類別的 assembly 方法
'''
