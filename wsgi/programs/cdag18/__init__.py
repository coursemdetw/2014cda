...
class CDAG18(object):
    ...
    def index(self, *args, **kwargs):
        outstring = '''
這是 2014CDA 協同專案下的 cdag18分組程式開發網頁, 以下為 W12 的任務執行內容.<br />
<!-- 這裡採用相對連結, 而非網址的絕對連結 (這一段為 html 註解) -->
<a href="cube1">cdag18 正方體參數繪圖</a>(尺寸變數 a, b, c)<br /><br />
...
'''
    ...
    import programs.cdag18 as cdag18
    root.cdag18 = cdag18.CDAG18()
