...
import programs.cdag10.man as cdag10_man
# 加入 cdag10 模組下的 man.py 且以子模組 man 對應其 MAN() 類別
...
var descr = pfcCreate("pfcModelDescriptor").CreateFromFileName ("v:/home/lego/cd/"+part2);
...
var featID = three_plane_assembly(session, assembly, transf, 0, 0, "g1.prt", "ASM_TOP", "ASM_FRONT", "ASM_RIGHT", "TOP", "FRONT", "RIGHT"); 
// 利用函式呼叫組立右手 ARM, 組立增量次序為 1
axis_plane_assembly(session, assembly, transf, featID, 0, 
                              "02.prt", "TOP", "A_4" , "TOP" , "A_4");

axis_plane_assembly(session, assembly, transf, featID, 0, 
                              "03-1.prt", "DTM1","A_4", "TOP","A_1" );
