...
class CDAG12(object):
    ...
    def index(self, *args, **kwargs):
        outstring = '''
這是 2014CDA 協同專案下的 cdag12 分組程式開發網頁, 以下為 W12 的任務執行內容.<br />
<!-- 這裡採用相對連結, 而非網址的絕對連結 (這一段為 html 註解) -->
<a href="cube1">cdag12 正方體參數繪圖</a>(尺寸變數 a, b, c)<br /><br />
...
'''
    ...
    import programs.cdag12 as cdag12
    root.cdag12 = cdag12.CDAG12()
    
    則程式啟動後, 可以利用 /cdag12/cube1 呼叫函式執行
    '''
    @cherrypy.expose
