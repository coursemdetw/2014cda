...
//1
three_plane_assembly(session, assembly, transf, featID, 0, "axle_5.prt", "DTM5", "FRONT", "DTM4", "TOP", "FRONT", "TOP");

//2
three_plane_assembly(session, assembly, transf, featID, 0, "axle_5.prt", "DTM5", "FRONT", "DTM5", "TOP", "FRONT", "TOP");
