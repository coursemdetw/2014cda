...
//3
three_plane_assembly(session, assembly, transf, featID, 0, "crossblock3.prt", "DTM7", "DTM5", "DTM1", "FRONT", "DTM2");

//4
three_plane_assembly(session, assembly, transf, featID, 0, "crossblock3.prt", "DTM7", "DTM4", "DTM1", "FRONT", "DTM2");
