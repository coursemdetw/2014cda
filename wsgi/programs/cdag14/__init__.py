...
//2
three_plane_assembly(session, assembly, transf, featID, 0, "axle_5.prt", "DTM4", "FRONT", "DTM1", "RIGHT", "FRONT", "DTM1");
...
//4
three_plane_assembly(session, assembly, transf, featID, 3, "crossblock3.prt", "FRONT", "DTM6", "DTM2", "DTM2", "DTM12", "FRONT");

//5
three_plane_assembly(session, assembly, transf, featID, 3, "crossblock3.prt", "FRONT", "DTM6", "DTM1", "DTM2", "DTM12", "FRONT");
...
//8
three_plane_assembly(session, assembly, transf, featID, 3, "beam_5.prt", "DTM6", "DTM3", "FRONT", "TOP", "DTM3", "FRONT");

//9
three_plane_assembly(session, assembly, transf, featID, 1, "crossblockb.prt", "DTM2", "RIGHT", "FRONT", "DTM6", "DTM5", "FRONT");

//10
three_plane_assembly(session, assembly, transf, featID, 9, "beam_5.prt", "TOP", "FRONT", "RIGHT", "DTM5", "RIGHT", "FRONT");

//11
//three_plane_assembly(session, assembly, transf, featID, 9, "conn.prt", "DTM9", "RIGHT", "A_2", "DTM2", "RIGHT", "A_1");
