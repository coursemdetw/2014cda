...
var featID = three_plane_assembly(session, assembly, transf, 1, -1, "crossblock_black.prt", "ASM_TOP", "ASM_FRONT", "ASM_RIGHT", "DTM4", "DTM3", "RIGHT"); 
...
//three_plane_assembly(session, assembly, transf, featID, 0, "crossblock_black.prt", "middle_green", "red", "blue", "DTM1", "RIGHT", "FRONT");
